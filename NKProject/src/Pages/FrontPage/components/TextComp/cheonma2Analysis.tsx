  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography variant="body1" sx={{ textAlign: "center", padding: "10px", margin: 0 }}>
          {subtext_1}
        </Typography>
